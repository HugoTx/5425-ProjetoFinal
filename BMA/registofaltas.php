...
<body>
    ...
    <div class="container w-50 mt-5 mb-4 border border-5 ">
        <form action="includes/APIsumarios.php?acao=registaFalta" method="POST">
            <h2 class="text-center">Registo de Faltas</h2>
        ...
        <div class="text-center mb-2 mt-4">
            <a href="entrada.php"><button class="btn btn-outline-secondary w-100 p-2 text-uppercase">Retroceder</button></a>
        </div>
    </div>
